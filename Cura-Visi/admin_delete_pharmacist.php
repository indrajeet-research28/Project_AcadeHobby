...
$sql="delete from pharmacist where staff_id='$sid'";
...
if(! $retval )
{
		...
		$message1="<center><font color=red>Delete Failed, Try again</font></center>";
}else{
...
<div class="grid_7">
		...
		<center><form action="#" method="post" >
			<table width="220" height="106" border="0" >	
				...
				<tr><td align="center"><input name="submit" type="submit" value="Delete"/></td></tr>
			</table>
		</form></center>
		<?php echo $message;
			  echo $message1;
